...
<body>
    ...
    <main>
        ...
        <!-- HEROセクション -->
        <section class="web-hero pf-project-hero pf-project-hero--cooking-site">
        ...
        <div class="pf-img__pc-none pc-none">
            <img src="/img/service/portfolio/web/alphaberry-group.com:cooking/responsive-image_cooking-site.png" alt="">            
        </div>
        ...
        <section class="pf-project-body helper__wrapper-basic">
            ...
            <div class="pf-project-body__img-container">
                <img src="/img/service/portfolio/web/alphaberry-group.com:cooking/responsive-image_cooking-site.png" alt="" class="sp-none">
                <img src="/img/service/portfolio/web/alphaberry-group.com:cooking/pc-preview_cooking-site.jpg" alt="">
                <img src="/img/service/portfolio/web/alphaberry-group.com:cooking/sp-preview_cooking-site.jpg" alt="">
                <img src="/img/service/portfolio/web/alphaberry-group.com:cooking/tab-preview_cooking-site.jpg" alt="">
            ...
            <div class="pf-project-body__txt-container">
                <table>
                    <tbody>
                        ...
                        <tr>
                            <th>URL</th>
                            <td><a href="https://alphaberry-group.com/cooking/" target="blank">https://alphaberry-group.com/cooking/</a></td>
                        </tr>
                        <tr>
                            <th>担当内容</th>
                        ...
                        <tr>
                            <th>サイト概要</th>
                            <td>　忙しい方や高齢者向けに料理代行を提供するサービスのサイトを制作しました。オレンジを基調に、親しみやすさと温かみを感じさせるデザインを採用しました。食欲をそそるイメージを色で表現しました。</td>
                        </tr>
                    </tbody>
                </table>
